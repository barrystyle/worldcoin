...
const char * const BITCOIN_CONF_FILENAME = "worldcoin.conf";
...
{
    // Windows: C:\Users\Username\AppData\Roaming\Worldcoin
    // macOS: ~/Library/Application Support/Worldcoin
    // Unix-like: ~/.bitcoin
#ifdef WIN32
    // Windows
...
#ifdef MAC_OSX
    // macOS
    return pathRet / "Library/Application Support/Worldcoin";
#else
    // Unix-like
...
std::string CopyrightHolders(const std::string& strPrefix)
{
    ...
    // Make sure Worldcoin Core copyright is not removed by accident
