...
void BitcoinApplication::initializeResult(bool success)
{
    ...
    if(success)
    {
        ...
        // worldcoin: URIs or payment requests:
        if (paymentServer) {
...
{
    QMessageBox::critical(nullptr, "Runaway exception", BitcoinGUI::tr("A fatal error occurred. Worldcoin can no longer continue safely and will quit.") + QString("\n\n") + message);
    ::exit(EXIT_FAILURE);
}
...
int GuiMain(int argc, char* argv[])
{
    ...
    // worldcoin: links repeatedly have their payment requests routed to this process:
    if (WalletModel::isWalletEnabled()) {
